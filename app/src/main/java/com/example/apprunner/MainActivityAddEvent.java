...
public class MainActivityAddEvent extends AppCompatActivity  {
    ...
    Button pickDate_start,pickDate_end,buttonsubmit,buttonAdd,addpicture,btn_addPicture,btnCancel;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validateAddevent(id_user,organizer, event, producer, date_start, date_end, objective, detail)) {
                    doAddevent(id_user,editorganizer, editevent, editproducer, textdatestart, textdateend, editobjective, editdetail);
                }
            }

            private boolean validateAddevent(int id_user,String organizer, String event, String producer, String date_start, String date_end, String objective, String detail) {
            ...
            private void doAddevent(int id_user,EditText editorganizer, final EditText editevent, final EditText editproducer, TextView textdatestart, TextView textdateend, EditText editobjective, EditText editdetail) {
                uploadImage(id_user,editorganizer, editevent, editproducer, textdatestart, textdateend, editobjective, editdetail);
            }
        });
    ...
    private void uploadImage(final int id_user,final EditText editorganizer, final EditText editevent, final EditText editproducer, final TextView textdatestart, final TextView textdateend, final EditText editobjective, final EditText editdetail) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            downloadUri.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    add_event(id_user,photoStringLink,editorganizer, editevent, editproducer, textdatestart, textdateend, editobjective, editdetail);
                                }
                            });
                        }
                    })
    ...
    private boolean checkIfValidAndRead() {
        ...
        for(int i=0;i<layoutlist.getChildCount();i++){
            ...
            Cricketer cricketer = new Cricketer(Integer.parseInt(ID_E), name_distance, distance, price);
            ...
            Call<Cricketer> call = services.insertDistance(new CricketerDB(Integer.parseInt(ID_E),editevent.getText().toString(),cricketersList.get(i).getNameDistance(),cricketersList.get(i).getDistance(),cricketersList.get(i).getPrice()));
    ...
    public void add_event(int id_user,String photoStringLink,EditText editorganizer, final EditText editevent, final EditText editproducer, TextView textdatestart, TextView textdateend, EditText editobjective, EditText editdetail){
        MainActivity mainActivity = new MainActivity();
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(mainActivity.url)
                .addConverterFactory(GsonConverterFactory.create())
